...
[![Level](https://img.shields.io/badge/Current_Dungeon-Level_10-blueviolet.svg?style=flat-square&logo=gamepad)](levels/latest.json)
...
## 🗺️ Current Dungeon: `Crypt of the Cursed Knight #10`
*Generated at: **September 25, 2026 - 06:45 PM BST** | Seed: `0x207918`*
...
| **Monsters Active** | `8 Enemies` (`👾`, `💀`, `🐉`) | **Hidden Traps** | `5 Spikes` (`🔥`) |
| **Treasure Chests** | `1 Chests` (`💎`) | **Minimum A\* Steps** | `45 Steps to Exit` |
